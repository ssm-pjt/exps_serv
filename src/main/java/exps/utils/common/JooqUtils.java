...
import exps.utils.common.constant.ConditionType;
...
import static exps.utils.common.constant.ConditionType.eq;
...
public class JooqUtils {
    ...
    public static <T extends Table> void resetTable(DSLContext dsl, T table) {
        ...
        exps.utils.common.JooqUtils.resetAutoincrement(dsl, table);
    }
    ...
    public static List<String> makeObject(Table<?> table, boolean apiModel) {
        ...
        objectList.add("테이블 코멘트: "+(apiModel ? "@Tag(name=\""+table.getComment()+"\")" : table.getComment()));
